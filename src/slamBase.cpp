...
//just ORB,do not use the last parameter
void computeKeyPointsAndDesp( FRAME& frame, string detector, string descriptor )
{   
    cv::Ptr<FeatureDetector> _detector = ORB::create();
    cv::Ptr<DescriptorExtractor> _descriptor = ORB::create();
...
static ParameterReader pd;
    ...
    // 求解pnp
    cv::solvePnPRansac( pts_obj, pts_img, cameraMatrix, cv::Mat(), rvec, tvec, true, 100, 6.0, 0.68, inliers );
